...
const BADGES = [
  { label: 'Naive → Agentic',  color: '#2563b0', dim: '#eff6ff' },
  { label: 'Fintech-First',    color: '#7c3aed', dim: '#f5f3ff' },
  { label: 'Production Ready', color: '#059669', dim: '#f0fdf4' },
]
    ...
    >
      ...
      <div style={{ maxWidth: 800, width: '100%', textAlign: 'center', position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          <br />
          <span style={{
            background: 'linear-gradient(130deg, #2563b0 0%, #1d4ed8 55%, #2563b0 100%)',
        ...
        <motion.p
          ...
          style={{
            ...
            color: '#6a6860', lineHeight: 1.7,
            maxWidth: 580, margin: '0 auto 42px', fontWeight: 400,
          }}
        >
          A hands-on workshop covering all{' '}
          <span style={{ color: '#1a1a18', fontWeight: 500 }}>26 production RAG patterns</span>
        ...
        >
          ...
          >
            <svg width="18" height="26" viewBox="0 0 18 26" fill="none">
              <rect x="1" y="1" width="16" height="24" rx="8" stroke="rgba(26,26,24,0.2)" strokeWidth="1.2"/>
              <motion.rect
                x="8" y="5.5" width="2" height="5" rx="1" fill="rgba(26,26,24,0.2)"
